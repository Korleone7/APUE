...
int main(int argc, char *argv[])
{
	...
	for(i = 0; i < n; i++) {//出口1,父进程专用出口
		...
		//printf("for i arr[0] arr[1] arr[2] %d %d %d %d\n", i, arr[0], arr[1], arr[2]);
	}
	//printf("i arr[0] arr[1] arr[2] %d %d %d %d\n", i, arr[0], arr[1], arr[2]);
